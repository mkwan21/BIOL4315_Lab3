...
The N50 from BUSCO (51 kbp) is the same as the N50 from flye (511072 bp).

The total assembly length is 12756536 bp.

## Question 3

The genome fraction from quast is 52.9%. The genome fraction from BUSCO is 33.7%.

The duplication ratio from quast is 1.049.

According to quast there are 0 misassemblies with length 0.  This, along with the low genome fraction, suggests the reference genome does not do a good job representing the genomic diversity of the species.
